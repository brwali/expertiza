describe MetareviewResponseMap do
  ...
  let(:student) { build(:student, id: 1, name: 'name', name: 'no one', email: 'expertiza@mailinator.com') }
  let(:student1) { build(:student, id: 2, name: 'name1', name: 'no one', email: 'expertiza@mailinator.com') }
  let(:student2) { build(:student, id: 3, name: 'name2', name: 'no one', email: 'expertiza@mailinator.com') }
