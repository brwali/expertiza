describe CourseSurveyResponseMap do
  let(:participant) { build(:participant, user_id: 1, user: build(:student, name: 'Jane', name: 'Doe, Jane', id: 1)) }
  ...
  let(:user) { build(:student, email: 'expertiza.debugging@gmail.com', name: 'Jane', name: 'Doe, Jane', id: 1) }
