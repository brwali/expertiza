describe SignUpTopic do
  ...
  describe '.drop_signup_record' do
    let(:instructor) { User.create!(name: 'Instructor', name: 'FullInstructor', email: 'instructor@example.com', password: 'securepassword', password_confirmation: 'securepassword') }
