describe Duty do
  ...
  let(:user) { build(:student, id: 1, name: 'no name', name: 'no one', participants: [participant]) }
  let(:user2) { build(:student, id: 2, name: 'no name2', name: 'no one2', participants: [participant2]) }
  let(:user3) { build(:student, id: 3, name: 'no name3', name: 'no one3', participants: [participant3]) }
