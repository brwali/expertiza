class SubmittedContentController < ApplicationController
  ...
  def submit_hyperlink
    ...
    if team_hyperlinks.include?(params['submission'])
      ExpertizaLogger.error LoggerMessage.new(controller_name, @participant.username, 'You or your teammate(s) have already submitted the same hyperlink.', request)
      ...
      begin
        ...
        ExpertizaLogger.error LoggerMessage.new(controller_name, @participant.username, "The URL or URI is invalid. Reason: #{$ERROR_INFO}", request)
        flash[:error] = "The URL or URI is invalid. Reason: #{$ERROR_INFO}"
      end
      @participant.mail_assigned_reviewers
      ExpertizaLogger.info LoggerMessage.new(controller_name, @participant.username, 'The link has been successfully submitted.', request)
  ...
  def remove_hyperlink
    ...
    ExpertizaLogger.info LoggerMessage.new(controller_name, @participant.username, 'The link has been successfully removed.', request)
  ...
  def submit_file
    ...
    ExpertizaLogger.info LoggerMessage.new(controller_name, participant.username, 'The file has been submitted.', request)
  ...
  def delete_selected_files
    ...
    ExpertizaLogger.info LoggerMessage.new(controller_name, @participant.username, 'The selected file has been deleted.', request)
  end
